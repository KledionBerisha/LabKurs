...
const FabrikaAndPunetori = lazy(() => import('../pages/FabrikaAndPunetori'))
const Vizitat = lazy(() => import('../pages/Vizitat'))
const TheVisit = lazy(() => import('../pages/TheVisit'))
const EditVizita = lazy(() => import('../pages/EditVizita'))
